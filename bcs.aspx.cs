...
public partial class bcs : System.Web.UI.Page
{
    ...
    protected void BindGrid()
    {
        try
        {
            ...
            string Query = "select beat_id, beat, totalbcs, a, b, c, historysheet,absentbcs, targethistorysheet, targetabsendbcs from FieldWorkMgt_DB.dbo.bcs where ps_code = " + PSCode+ "order by beat";
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Deletes")
        {
            try
            {
                ...
                string Query = "delete FROM FieldWorkMgt_DB.dbo.bcs where beat_id=" + id;
                DataBase DB = new DataBase();
                DB.DeleteData(Query);
                BindGrid();
            }
