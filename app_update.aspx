<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="app_update.aspx.cs" Inherits="app_update" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content" style="width: 90%;">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <h3 class="box-title" style="margin-left: 15px;">App Updates</h3>
        ...
        <asp:GridView ID="GridView1" Style="width: 100%; margin-left: 0%;" AutoGenerateColumns="False" DataKeyNames="case_id" 
            ...
            <Columns>
              <asp:TemplateField HeaderText="S.No." ItemStyle-Width="1">
                ...
                <asp:BoundField DataField="case_id" HeaderText="case_id" ItemStyle-Width="8%"  Visible="false"/>
                <asp:BoundField DataField="totalcasesPI" HeaderText="Total No. of Cases PI" />  
                <asp:BoundField DataField="totalcasesupdatedabout" HeaderText="Total No of Cases in which complainant updated about progress" />  
                <asp:BoundField DataField="targetweek" HeaderText="Target for week" /> 
            ...
            <asp:TemplateField HeaderText="Action" ItemStyle-Width="10%" >
             <ItemTemplate>
                        <a href='app_update1.aspx?CaseId=<%# Eval("case_id") %>'>
                            <img src="images/edit.ico" style="height: 20px; margin-right: 20px; width: 20px;" title="Edit" />
                        </a>
                        <asp:LinkButton ToolTip="Delete" ID="R1" runat="server" CommandArgument='<%# Eval("case_id") %>' OnClientClick="return confirm('Are you sure to remove this Delivery?');" CommandName="Deletes"><img src="images/Delete_icon.png" style="height: 20px;width: 20px;" /> </asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
                </Columns>
            </asp:GridView>
