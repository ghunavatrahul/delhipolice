<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="criminal_arrest.aspx.cs" Inherits="criminal_arrest" %>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <h3 class="box-title" style="margin-left: 15px;">Criminal Arrest</h3>
                    <div class="box-header with-border">
                        <h3 class="box-title">Criminal Arrest</h3>
