<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="target_on_gangs.aspx.cs" Inherits="target_on_gangs" %>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <h3 class="box-title" style="margin-left: 15px;">Target on Gangs</h3>
                    <div class="box-header with-border">
                        <h3 class="box-title">Target on Gangs</h3>
                ...
                <div class="box box-info">
                    <h3 class="box-title" style="margin-left: 15px;">Target of Cyber Team</h3>
                    <div class="box-header with-border">
                        <h3 class="box-title">Target of Cyber Team</h3>
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="collapse">
                                <i class="fa fa-minus"></i>
                            </button>
                ...
                <div class="box box-info">
                    <h3 class="box-title" style="margin-left: 15px;">Target : List of top 5 Criminal</h3>
                    <div class="box-header with-border">
                        <h3 class="box-title">Target : List of top 5 Criminal</h3>
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="collapse">
                                <i class="fa fa-minus"></i>
                            </button>
