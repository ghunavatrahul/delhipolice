<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="ps_home.aspx.cs" Inherits="ps_home" %>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <h3 class="box-title" style="margin-left: 15px;">Police station at a glance</h3>
                    <div class="box-header with-border">
                        <h3 class="box-title">Police station at a glance</h3>
                ...
                <div class="box box-info">
                    <h3 class="box-title" style="margin-left: 15px;">Deatils of division and beat</h3>
                    <div class="box-header with-border">
                        <h3 class="box-title">Deatils of division and beat</h3>
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="collapse">
                                <i class="fa fa-minus"></i>
                            </button>
