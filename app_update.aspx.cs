...
public partial class app_update : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("app_update1.aspx");
    }
    ...
    protected void BindGrid()
    {
        try
        {
            ...
            string Query = "select case_id,totalcasesPI,totalcasesupdatedabout,targetweek,whatsapp,sms,telephone,mail,physical from FieldWorkMgt_DB.dbo.app_update where ps_code = " + PSCode;
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Deletes")
        {
            try
            {
                ...
                string Query = "delete FROM FieldWorkMgt_DB.dbo.app_update where case_id=" + id;
                DataBase DB = new DataBase();
                DB.DeleteData(Query);
                BindGrid();
            }
