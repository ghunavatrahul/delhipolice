<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="senior_citizen.aspx.cs" Inherits="senior_citizen" %>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <h3 class="box-title" style="margin-left: 15px;">SENIOR CITIZENS</h3>
        ...
        <asp:GridView ID="GridView1" Style="width: 100%; margin-left: 0%;" AutoGenerateColumns="False" DataKeyNames="target_id" 
            ...
            <Columns>
              <asp:TemplateField HeaderText="S.No." ItemStyle-Width="1">
                ...
                <asp:BoundField DataField="target_id" HeaderText="target_id" ItemStyle-Width="8%"  Visible="false"/>
                <asp:BoundField DataField="target" HeaderText="Target" />  
                <asp:BoundField DataField="seniorcitcontactedday" HeaderText="Visited during the Day" />  
                <asp:BoundField DataField="seniorcitcontactedphone" HeaderText="Contacted on Phone during the Day" /> 
                <asp:BoundField DataField="srcitizensecuirityauditcomplete" HeaderText="Completed" />
                <asp:BoundField DataField="srcitizensecuirityauditprocess" HeaderText="In Process" />
                <asp:BoundField DataField="domestichelptarget" HeaderText="Target" />
                <asp:BoundField DataField="domestichelpformfill" HeaderText="Form Filled Up" />
                <asp:BoundField DataField="domestichelptargettwo" HeaderText="Target" />
                <asp:BoundField DataField="domestichelpvericomp" HeaderText="Verification Completed" />


            <asp:TemplateField HeaderText="Action" ItemStyle-Width="10%" >
             <ItemTemplate>
                        <a href='senior_citizen1.aspx?TargetId=<%# Eval("target_id") %>'>
                            <img src="images/edit.ico" style="height: 20px; margin-right: 20px; width: 20px;" title="Edit" />
                        </a>
                        <asp:LinkButton ToolTip="Delete" ID="R1" runat="server" CommandArgument='<%# Eval("target_id") %>' OnClientClick="return confirm('Are you sure to remove this Delivery?');" CommandName="Deletes"><img src="images/Delete_icon.png" style="height: 20px;width: 20px;" /> </asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
                </Columns>
            </asp:GridView>
