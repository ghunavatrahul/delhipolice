<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="prevention_action.aspx.cs" Inherits="prevention_action" %>
    ...
    <section class="content" style="width: 90%;">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <h3 class="box-title" style="margin-left: 15px;">Prevention Action</h3>
                    <div class="box-header with-border">
                        <h3 class="box-title">Prevention Action</h3>
                     ...
                     <div class="box" style="width: 98%; margin-left: 2%; margin-top: 0%; margin-right: 1%; margin-bottom: 5%">
                        <div class="btn btn-box-tool text-bold"><h4>Prevention Action</h4></div>
        ...
        <asp:GridView ID="GridView1" Style="width: 100%; margin-left: 0%;" AutoGenerateColumns="False" DataKeyNames="head_id" 
            ...
            <asp:TemplateField HeaderText="Action" ItemStyle-Width="10%" >
             <ItemTemplate>
                        <a href='prevention_action1.aspx?HeadId=<%# Eval("head_id") %>'>
