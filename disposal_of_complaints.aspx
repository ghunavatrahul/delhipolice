<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="disposal_of_complaints.aspx.cs" Inherits="disposal_of_complaints" %>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <h3 class="box-title" style="margin-left: 15px;">Disposal of Complaints</h3>
                    <div class="box-header with-border">
                        <h3 class="box-title">Disposal of Complaints</h3>
                ...
                <div class="box box-info">
                    <h3 class="box-title" style="margin-left: 15px;">Feedback</h3>
                    <div class="box-header with-border">
