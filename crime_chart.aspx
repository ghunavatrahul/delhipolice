<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="crime_chart.aspx.cs" Inherits="crime_chart" %>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <h3 class="box-title" style="margin-left: 15px;">STATEMENT OF CRIME NORTH DISTRICT DATED</h3>
                    <div class="box-header with-border">
                        <h3 class="box-title">STATEMENT OF CRIME NORTH DISTRICT DATED</h3>
                     ...
                     <div class="box" style="width: 98%; margin-left: 2%; margin-top: 0%; margin-right: 1%; margin-bottom: 5%">
                        <div class="btn btn-box-tool text-bold"><h4>STATEMENT OF CRIME NORTH DISTRICT DATED</h4></div>
        ...
        <asp:GridView ID="GridView1" Style="width: 100%; margin-left: 0%;" AutoGenerateColumns="False" DataKeyNames="head_id" 
            ...
            <Columns>
              <asp:TemplateField HeaderText="S.No." ItemStyle-Width="1">
                ...
                <asp:BoundField DataField="today2019rep" HeaderText="Today 2019 REP" />  
                <asp:BoundField DataField="today2019wo" HeaderText="Today 2019 W/O" /> 
                <asp:BoundField DataField="today2020rep" HeaderText="Today 2020 REP" />
                <asp:BoundField DataField="today2020wo" HeaderText="Today 2020 W/O" />
                <asp:BoundField DataField="uptodate2020rep" HeaderText="Upto Date 2020 REP" />
                <asp:BoundField DataField="uptodate2020wo" HeaderText="Upto Date 2020 W/O" />
                <asp:BoundField DataField="twentyninteen" HeaderText="2019" />
                <asp:BoundField DataField="uptodate2021rep" HeaderText="Upto Date 2021 REP" />
                <asp:BoundField DataField="uptodate2021wo" HeaderText="Upto Date 2021 W/O" />
                <asp:BoundField DataField="twentytwenty" HeaderText="2020" />
                <asp:BoundField DataField="variation" HeaderText="Variation" />
                <asp:BoundField DataField="uptotwentyninteen" HeaderText="Upto 31.12.2019" />


            <asp:TemplateField HeaderText="Action" ItemStyle-Width="10%" >
             <ItemTemplate>
                        <a href='crime_chart1.aspx?HeadId=<%# Eval("head_id") %>'>
