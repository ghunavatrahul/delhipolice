...
public partial class unsolved : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("unsolved1.aspx");
    }
    ...
    protected void BindGrid()
    {
        try
        {
            ...
            string Query = "select beat_id,headofcrime,firnumb,timeofoccurance,detailvictim,brieffact,detailaccused,effortmade,reasonnotarrest,targetto from FieldWorkMgt_DB.dbo.unsolved where ps_code = " + PSCode;
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Deletes")
        {
            try
            {
                ...
                string Query = "delete FROM FieldWorkMgt_DB.dbo.unsolved where beat_id=" + id;
                DataBase DB = new DataBase();
                DB.DeleteData(Query);
                BindGrid();
            }
