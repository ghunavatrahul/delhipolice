<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="promptnew.aspx.cs" Inherits="promptnew" %>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <h3 class="box-title" style="margin-left: 15px;">Communal Sensitive/Law and Order Issues</h3>
                    <div class="box-header with-border">
                        <h3 class="box-title">Communal Sensitive/Law and Order Issues</h3>
                     ...
                     <div class="box" style="width: 98%; margin-left: 2%; margin-top: 0%; margin-right: 1%; margin-bottom: 5%">
                        <div class="btn btn-box-tool text-bold"><h4>Communal Sensitive/Law and Order Issues</h4></div>
        ...
        <asp:GridView ID="GridView1" Style="width: 100%; margin-left: 0%;" AutoGenerateColumns="False" DataKeyNames="head_id" 
            ...
            <Columns>
              <asp:TemplateField HeaderText="S.No." ItemStyle-Width="1">
                ...
                <asp:BoundField DataField="focuspoint" HeaderText="Focus point" />  
                <asp:BoundField DataField="strategy" HeaderText="Strategy" />  
                <asp:BoundField DataField="given" HeaderText="Given" /> 
                <asp:BoundField DataField="achived" HeaderText="Achived" />


            <asp:TemplateField HeaderText="Action" ItemStyle-Width="10%" >
             <ItemTemplate>
                        <a href='promptnew1.aspx?PromptId=<%# Eval("head_id") %>'>
