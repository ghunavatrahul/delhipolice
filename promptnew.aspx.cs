...
public partial class promptnew : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("promptnew1.aspx");
    }
    ...
    protected void BindGrid()
    {
        try
        {
            ...
            string Query = "select head_id, focuspoint,strategy,given,achived from FieldWorkMgt_DB.dbo.promptnew where ps_code = " + PSCode;
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Deletes")
        {
            try
            {
                ...
                string Query = "delete FROM FieldWorkMgt_DB.dbo.promptnew where head_id=" + id;
                DataBase DB = new DataBase();
                DB.DeleteData(Query);
                BindGrid();
            }
