<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="NotificationAdd.aspx.cs" Inherits="NotificationAdd" %>
          ...
          <div class="row">
            <div class="col-md-6">
               <div class="form-group">
                ...
                <label>Subject</label>                               
                <asp:TextBox ID="txtSubject" class="form-control" runat="server" placeholder="Write Subject ..." style="margin-left: 0px;"></asp:TextBox>
               ...
               <div class="form-group" >
                 <label>Description </label>                 
                  <asp:TextBox ID="txtDescription" class="form-control" runat="server" placeholder="Write Description ..." TextMode="MultiLine" style="margin-left: 0px; height: 100px;"></asp:TextBox> 
            ...
            <div class="col-md-6">                                      
              <div class="form-group" >
                 <label>Notified To </label>                 
                  <asp:listbox runat="server" id="lstBoxTest" class="form-control" SelectionMode="Multiple" style="height: 174px;"></asp:listbox> 
