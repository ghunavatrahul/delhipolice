<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="vehicalpatrolling.aspx.cs" Inherits="vehicalpatrolling" %>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <h3 class="box-title" style="margin-left: 15px;">Vehical Patrolling</h3>
                    <div class="box-header with-border">
                        <h3 class="box-title">Vehical Patrolling</h3>
