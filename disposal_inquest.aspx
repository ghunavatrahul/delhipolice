<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="disposal_inquest.aspx.cs" Inherits="disposal_inquest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content" style="width: 90%;">
        ...
        <div class="row">
            <div class="col-md-12">
                <h3 style="margin-left: 20px;">Finalization </h3>
                <div class="box box-info">
                    <h3 class="box-title" style="margin-left: 15px;">Disposal of Pending Investigation Cases - Total</h3>
                    <div class="box-header with-border">
                        <h3 class="box-title">Disposal of Pending Investigation Cases - Total</h3>
                ...
                <div class="box box-info">
                    <h3 class="box-title" style="margin-left: 15px;">Details of Disposed off Cases of Today</h3>
                    <div class="box-header with-border">
                        <h3 class="box-title">Details of Disposed off Cases of Today</h3>
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="collapse">
                                <i class="fa fa-minus"></i>
                            </button>
                ...
                <div class="box box-info">
                    <h3 class="box-title" style="margin-left: 15px;">Disposal of Pending Investigation Cases - Period Wise</h3>
                    <div class="box-header with-border">
                        <h3 class="box-title">Disposal of Pending Investigation Cases - Period Wise</h3>
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="collapse">
                                <i class="fa fa-minus"></i>
                            </button>
                ...
                <div class="box box-info">
                    <h3 class="box-title" style="margin-left: 15px;">Disposal of Pending Investigation Cases</h3>
                    <div class="box-header with-border">
                        <h3 class="box-title">Disposal of Pending Investigation Cases</h3>
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="collapse">
                                <i class="fa fa-minus"></i>
                            </button>
                   ...
                   <div class="box box-info">
                    <h3 class="box-title" style="margin-left: 15px;">Monitoring of High Court Matters (Details of High Court Matter of Next 7 Days to be updated</h3>
                    <div class="box-header with-border">
                        <h3 class="box-title">Monitoring of High Court Matters (Details of High Court Matter of Next 7 Days to be updated<h3>
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="collapse">
                                <i class="fa fa-minus"></i>
                            </button>
                ...
                <div class="box box-info">
                    <h3 class="box-title" style="margin-left: 15px;">Disposal of Muds</h3>
                    <div class="box-header with-border">
                        <h3 class="box-title">Disposal of Muds<h3>
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="collapse">
                                <i class="fa fa-minus"></i>
                            </button>
