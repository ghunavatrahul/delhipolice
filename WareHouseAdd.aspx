<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="WareHouseAdd.aspx.cs" Inherits="WareHouseAdd" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">WareHouse</asp:Content>
            ...
            <div class="col-md-6">               
              ...
              <div class="form-group">               
               ...
               <asp:TextBox ID="txtFirstname" class="form-control" runat="server" placeholder="Enter First Name ..." style="margin-left: 0px;"></asp:TextBox>
                    ...
                    Display="Dynamic" ValidationGroup='valGroup1' ValidationExpression="[a-zA-Z ]*$" ErrorMessage="* Only Valid characters!" />
              </div>              
<%--              <div class="form-group">
                ...
                <asp:TextBox ID="txtEmailid" class="form-control" runat="server" placeholder="Enter Email ID ..." style="margin-left: 0px;"></asp:TextBox>
                    ...
                    ControlToValidate="txtEmailid" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ValidationGroup='valGroup1' ErrorMessage="* Invalid Email Format"></asp:RegularExpressionValidator>
              </div>--%>
                <div class="form-group">
              ...
              <div class="form-group" >
                 ...
                 <asp:TextBox ID="txtZipcode" class="form-control" runat="server" placeholder="Enter Zipcode..." style="margin-left: 0px;"></asp:TextBox>                  
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ForeColor="Red" ErrorMessage="* Please Enter ZipCode!" SetFocusOnError="true" 
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ControlToValidate="txtZipcode" MaxLength="16" ErrorMessage="! Only numeric allowed." 
                    ForeColor="Red" ValidationExpression="^[0-9]*$" ValidationGroup="valGroup1" Display="Dynamic" SetFocusOnError="true"></asp:RegularExpressionValidator> 
<%--                   <asp:RegularExpressionValidator Display = "Dynamic" ValidationGroup="valGroup1" ControlToValidate = "txtAddress1" ID="RegularExpressionValidator7" ValidationExpression = "^[\s\S]{0,10}$" runat="server" ErrorMessage="Maximum 10 characters allowed."></asp:RegularExpressionValidator>--%>
