<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="welfare.aspx.cs" Inherits="welfare" %>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <h3 class="box-title" style="margin-left: 15px;">Welfare of Staff</h3>
                    <div class="box-header with-border">
                        <h3 class="box-title">Welfare of Staff</h3>
                     ...
                     <div class="box" style="width: 98%; margin-left: 2%; margin-top: 0%; margin-right: 1%; margin-bottom: 5%">
                        <div class="btn btn-box-tool text-bold"><h4>Welfare of Staff</h4></div>
        ...
        <asp:GridView ID="GridView1" Style="width: 100%; margin-left: 0%;" AutoGenerateColumns="False" DataKeyNames="head_id" 
            ...
            <Columns>
              <asp:TemplateField HeaderText="S.No." ItemStyle-Width="1">
                ...
                <asp:BoundField DataField="insp" HeaderText="Insp" />  
                <asp:BoundField DataField="si" HeaderText="SI" /> 
                <asp:BoundField DataField="asi" HeaderText="ASI" />
            ...
            <asp:TemplateField HeaderText="Action" ItemStyle-Width="10%" >
             <ItemTemplate>
                        <a href='welfare1.aspx?HeadId=<%# Eval("head_id") %>'>
