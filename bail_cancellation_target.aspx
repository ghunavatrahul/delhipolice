<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="bail_cancellation_target.aspx.cs" Inherits="bail_cancellation_target" %>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <h3 class="box-title" style="margin-left: 15px;">Bail Cancellation Target</h3>
                    <div class="box-header with-border">
                        <h3 class="box-title">Bail Cancellation Target</h3>
                     ...
                     <div class="box" style="width: 98%; margin-left: 2%; margin-top: 0%; margin-right: 1%; margin-bottom: 5%">
                        <div class="btn btn-box-tool text-bold"><h4>Bail Cancellation Target</h4></div>
        <asp:Button ID="btnAdd" class="btn btn-info pull-right" runat="server" Text="Add Iteam" Style="margin-right:5%; background-color:#117A65;" OnClick="btnAdd_Click" />    
        <asp:GridView ID="GridView1" Style="width: 100%; margin-left: 0%;" AutoGenerateColumns="False" DataKeyNames="head_id" 
            ...
            <Columns>
              <asp:TemplateField HeaderText="S.No." ItemStyle-Width="1">
                ...
                <asp:BoundField DataField="crimehead" HeaderText="Crime Head" />  
                <asp:BoundField DataField="jailbailreleasedweek" HeaderText="Week" />  
                <asp:BoundField DataField="jailbailreleaseupto" HeaderText="upto date" /> 
                <asp:BoundField DataField="cancellationtarget" HeaderText="TARGET" />
                <asp:BoundField DataField="cancellationweek" HeaderText="Week" />
                <asp:BoundField DataField="cancellationupto" HeaderText="upto date" />
                <asp:BoundField DataField="pendingbyprocecution" HeaderText="Pending with Prosecution" />
                <asp:BoundField DataField="returnbyprocecution" HeaderText="Returned by Prosecution" />
                <asp:BoundField DataField="pendingincourt" HeaderText="Pending in courts" />
                <asp:BoundField DataField="accepeted" HeaderText="Accepted" />
                <asp:BoundField DataField="rejected" HeaderText="Rejected" />
                <asp:BoundField DataField="appledhighcourt" HeaderText="Appeal filed in High Court" />


            <asp:TemplateField HeaderText="Action" ItemStyle-Width="10%" >
             <ItemTemplate>
                        <a href='bail_cancellation_target1.aspx?HeadId=<%# Eval("head_id") %>'>
