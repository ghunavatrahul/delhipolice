...
public partial class anti_terrorist : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("anti_terrorist1.aspx");
    }
    ...
    protected void BindGrid()
    {
        try
        {
            ...
            string Query = "select head_id, head,totalnumber,targetofday,targetofweek,checkduringday,checkduringweek,cases,dpact from FieldWorkMgt_DB.dbo.anti_terrorist where ps_code = " + PSCode;
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Deletes")
        {
            try
            {
                ...
                string Query = "delete FROM FieldWorkMgt_DB.dbo.anti_terrorist where head_id=" + id;
                DataBase DB = new DataBase();
                DB.DeleteData(Query);
                BindGrid();
            }
