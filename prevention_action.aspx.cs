...
public partial class prevention_action : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("prevention_action1.aspx");
    }
    ...
    protected void BindGrid()
    {
        try
        {
            ...
            string Query = "select head_id,head,target,day,week,uptodate from FieldWorkMgt_DB.dbo.prevention_action where ps_code = " + PSCode+ "order by head";
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Deletes")
        {
            try
            {
                ...
                string Query = "delete FROM FieldWorkMgt_DB.dbo.prevention_action where head_id=" + id;
                DataBase DB = new DataBase();
                DB.DeleteData(Query);
                BindGrid();
            }
