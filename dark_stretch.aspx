<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="dark_stretch.aspx.cs" Inherits="dark_stretch" %>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <h3 class="box-title" style="margin-left: 15px;">DARK STRETCHES</h3>
                    <div class="box-header with-border">
                        <h3 class="box-title">DARK STRETCHES</h3>
