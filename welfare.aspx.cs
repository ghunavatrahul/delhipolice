...
public partial class welfare : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("welfare1.aspx");
    }
    ...
    protected void BindGrid()
    {
        try
        {
            ...
            string Query = "select head_id,head,insp,si,asi,hc,ct,total,target from FieldWorkMgt_DB.dbo.welfare_of_staff where ps_code = " + PSCode;
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Deletes")
        {
            try
            {
                ...
                string Query = "delete FROM FieldWorkMgt_DB.dbo.welfare_of_staff where head_id=" + id;
                DataBase DB = new DataBase();
                DB.DeleteData(Query);
                BindGrid();
            }
