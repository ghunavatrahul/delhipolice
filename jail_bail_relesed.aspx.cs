...
public partial class jail_bail_relesed : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("jail_bail_relesed1.aspx");
    }
    ...
    protected void BindGrid()
    {
        try
        {
            ...
            string Query = "select beat_id,beat ,totalbailrelesed ,verified ,unverified,tobeverified ,totaljailbail ,verifiedjail ,unverifiedjail,tobeverifiedjail from FieldWorkMgt_DB.dbo.jail_bail_relesed where ps_code = " + PSCode+ "order by beat";
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Deletes")
        {
            try
            {
                ...
                string Query = "delete FROM FieldWorkMgt_DB.dbo.jail_bail_relesed where beat_id=" + id;
                DataBase DB = new DataBase();
                DB.DeleteData(Query);
                BindGrid();
            }
