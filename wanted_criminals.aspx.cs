...
public partial class wanted_criminals : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("wanted_criminals1.aspx");
    }
    ...
    protected void BindGrid()
    {
        try
        {
            ...
            string Query = "select wanted_id, details,detailsofgang,rivalgang,associatesofcrimals,detailscasehewanted,assiendpoliceofficer,effortsduringday from FieldWorkMgt_DB.dbo.wanted_criminals where ps_code = " + PSCode;
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Deletes")
        {
            try
            {
                ...
                string Query = "delete FROM FieldWorkMgt_DB.dbo.wanted_criminals where wanted_id=" + id;
                DataBase DB = new DataBase();
                DB.DeleteData(Query);
                BindGrid();
            }
