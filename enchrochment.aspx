<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="enchrochment.aspx.cs" Inherits="enchrochment" %>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <h3 class="box-title" style="margin-left: 15px;">Encroachment</h3>
                    <div class="box-header with-border">
                        <h3 class="box-title">Encroachment</h3>
                ...
                <div class="box box-info">
                    <h3 class="box-title" style="margin-left: 15px;">Encroachment Strategy</h3>
                    <div class="box-header with-border">
                        <h3 class="box-title">Encroachment Strategy</h3>
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="collapse">
                                <i class="fa fa-minus"></i>
                            </button>
