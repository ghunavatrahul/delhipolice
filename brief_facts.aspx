<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="brief_facts.aspx.cs" Inherits="brief_facts" %>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <h3 class="box-title" style="margin-left: 15px;">Brief Facts of Cases</h3>
                    <div class="box-header with-border">
                        <h3 class="box-title">Brief Facts of Cases</h3>
