<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="e_beat_book.aspx.cs" Inherits="e_beat_book" %>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <h3 class="box-title" style="margin-left: 15px;">E-Beat Book</h3>
                    <div class="box-header with-border">
                        <h3 class="box-title">E-Beat Book</h3>
        ...
        <asp:GridView ID="GridView1" Style="width: 100%; margin-left: 0%;" AutoGenerateColumns="False" DataKeyNames="beat_id" 
            ...
            <Columns>
              <asp:TemplateField HeaderText="S.No." ItemStyle-Width="1">
                ...
                <asp:BoundField DataField="beatnumb" HeaderText="Beat No." />  
                <asp:BoundField DataField="databanktotal" HeaderText="Total" />  
                <asp:BoundField DataField="jailbailcompleted" HeaderText="Completed" /> 
                <asp:BoundField DataField="jailbailtarget" HeaderText="Target" />
                <asp:BoundField DataField="nineparttwovisitcompleted" HeaderText="Completed" />
                <asp:BoundField DataField="nineparttwovisittarget" HeaderText="Target" />
                <asp:BoundField DataField="grandtotal" HeaderText="Grand Total" />


            <asp:TemplateField HeaderText="Action" ItemStyle-Width="10%" >
             <ItemTemplate>
                        <a href='e_beat_book1.aspx?BeatId=<%# Eval("beat_id") %>'>
