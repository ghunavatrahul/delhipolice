<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="Manpower.aspx.cs" Inherits="Manpower" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content" style="width: 90%;">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <h3 class="box-title" style="margin-left: 15px;">Manpower</h3>
                ...
                <div class="box box-info">
                    <h3 class="box-title" style="margin-left: 15px;">Manpower Deployement</h3>
                    <div class="box-header with-border">
                        <h3 class="box-title">Manpoer Deployement</h3>
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="collapse">
                                <i class="fa fa-minus"></i>
                            </button>
        ...
        <asp:Button ID="btnAdd" class="btn btn-info pull-right" runat="server" Text="Add Deployment" Style="margin-right:5%; background-color:#117A65;" OnClick="btnAdd_Click" />    
        <asp:GridView ID="GridView3" Style="width: 100%; margin-left: 0%;" AutoGenerateColumns="False" DataKeyNames="deployment_id" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="deployment_id" HeaderText="deployment_id" ItemStyle-Width="8%"  Visible="false"/>
                <asp:BoundField DataField="mud_static_duty" HeaderText="Mud/Static Duty" />  
                <asp:BoundField DataField="us" HeaderText="U/S" />  
                <asp:BoundField DataField="HC" HeaderText="HC" /> 
                <asp:BoundField DataField="CT" HeaderText="CT" />  
                <asp:BoundField DataField="Total" HeaderText="Total" />
                <asp:BoundField DataField="pattern_timing" HeaderText="Pattern/Timings of Duty" />

                <asp:TemplateField HeaderText="Action" ItemStyle-Width="10%" >
                    <ItemTemplate>
                        <a href='Manpower1.aspx?DeploymentId=<%# Eval("deployment_id") %>'>
                            <img src="images/edit.ico" style="height: 20px; margin-right: 20px; width: 20px;" title="Edit" />
                        </a>
                        <asp:LinkButton ToolTip="Delete" ID="R1" runat="server" CommandArgument='<%# Eval("deployment_id") %>' OnClientClick="return confirm('Are you sure to remove this Delivery?');" CommandName="Deletes"><img src="images/Delete_icon.png" style="height: 20px;width: 20px;" /> </asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
