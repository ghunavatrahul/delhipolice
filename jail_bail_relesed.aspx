<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="jail_bail_relesed.aspx.cs" Inherits="jail_bail_relesed" %>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <h3 class="box-title" style="margin-left: 15px;">JAIL BAIL RELEASE</h3>
                    <div class="box-header with-border">
                        <h3 class="box-title">JAIL BAIL RELEASE </h3>
        ...
        <asp:GridView ID="GridView1" Style="width: 100%; margin-left: 0%;" AutoGenerateColumns="False" DataKeyNames="beat_id" 
            ...
            <Columns>
              <asp:TemplateField HeaderText="S.No." ItemStyle-Width="1">
                ...
                <asp:BoundField DataField="beat" HeaderText="BEAT" />  
                <asp:BoundField DataField="totalbailrelesed" HeaderText="TOTAL JAIL BAIL RELEASE" />  
                <asp:BoundField DataField="verified" HeaderText="VERIFIED" /> 
                <asp:BoundField DataField="unverified" HeaderText="UNVERIFIED" />
                <asp:BoundField DataField="tobeverified" HeaderText="TO BE VERIFIED (TARGET)" />
                <asp:BoundField DataField="totaljailbail" HeaderText="TOTAL JAIL BAIL RELEASED ROBBER, SNATCHER, DACOITS & DREADED CRIMINALS" />
                <asp:BoundField DataField="verifiedjail" HeaderText="VERIFIED" />
                <asp:BoundField DataField="unverifiedjail" HeaderText="UNVERIFIED" />
                <asp:BoundField DataField="tobeverifiedjail" HeaderText="TO BE VERIFIED (TARGET)" />


            <asp:TemplateField HeaderText="Action" ItemStyle-Width="10%" >
             <ItemTemplate>
                        <a href='jail_bail_relesed1.aspx?BeatId=<%# Eval("beat_id") %>'>
